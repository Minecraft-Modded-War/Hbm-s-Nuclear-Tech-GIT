...
public class ItemRenderRevolverNightmare extends TEISRBase {
	...
	protected ResourceLocation n1Loc = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelNightmare.png");
	protected ResourceLocation n2Loc = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelNightmare2.png");
