...
public class ItemRenderMinigun extends TEISRBase {
	...
	protected static ResourceLocation minigun_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelLacunae.png");
	protected static ResourceLocation avenger_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelLacunaeAvenger.png");
	protected static ResourceLocation lacunae_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelLacunaeReal.png");
