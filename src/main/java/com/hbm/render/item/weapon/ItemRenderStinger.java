...
public class ItemRenderStinger extends TEISRBase {
	...
	protected static ResourceLocation stinger_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelStinger.png");
	protected static ResourceLocation skystinger_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelSkyStinger.png");
