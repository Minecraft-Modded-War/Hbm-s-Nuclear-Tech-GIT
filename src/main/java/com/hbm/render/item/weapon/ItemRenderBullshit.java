...
public class ItemRenderBullshit extends TEISRBase {
	...
	protected static ResourceLocation mp40_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelMP40.png");
	protected static ResourceLocation spark_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelSpark.png");
	protected static ResourceLocation pip_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelPip.png");
	protected static ResourceLocation bomb_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/BaleFlare.png");
