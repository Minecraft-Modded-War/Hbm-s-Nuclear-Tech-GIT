...
public class ItemRenderRpg extends TEISRBase {
	...
	protected static ResourceLocation gustav_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelGustav.png");
	protected static ResourceLocation karl_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelGustavYellow.png");
	protected static ResourceLocation panzer_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelPanzerschreck.png");
