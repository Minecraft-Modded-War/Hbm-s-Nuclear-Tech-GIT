...
public class ItemRenderUzi extends TEISRBase {
	...
	protected static ResourceLocation uzi_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelUzi.png");
	protected static ResourceLocation sat_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelUziSaturnite.png");
	protected static ResourceLocation barrel_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelUziBarrel.png");
	protected static ResourceLocation silencer_rl = new ResourceLocation(MainRegistry.MODID +":textures/models/ModelUziSilencer.png");
