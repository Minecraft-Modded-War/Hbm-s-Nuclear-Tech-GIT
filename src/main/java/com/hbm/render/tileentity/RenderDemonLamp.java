...
public class RenderDemonLamp extends TileEntitySpecialRenderer<TileEntityDemonLamp> {
	...
	public static final IModelCustom demon_lamp = new HFRWavefrontObject(new ResourceLocation(MainRegistry.MODID, "models/blocks/demon_lamp.obj"));
	public static final ResourceLocation tex = new ResourceLocation(MainRegistry.MODID, "textures/models/machines/demon_lamp.png");
