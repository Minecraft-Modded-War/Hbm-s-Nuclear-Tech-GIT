...
public class RenderBlackHole extends Render<EntityBlackHole> {
	...
	protected static final ResourceLocation objTesterModelRL = new ResourceLocation(MainRegistry.MODID, "models/Sphere.obj");
	protected IModelCustom blastModel;
	protected ResourceLocation hole = new ResourceLocation(MainRegistry.MODID, "textures/models/BlackHole.png");
	protected ResourceLocation swirl = new ResourceLocation(MainRegistry.MODID, "textures/entity/bhole.png");
	protected ResourceLocation disc = new ResourceLocation(MainRegistry.MODID, "textures/entity/bholeDisc.png");
