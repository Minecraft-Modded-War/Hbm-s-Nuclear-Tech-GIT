...
public class RenderBombletSelena extends Render<EntityBombletSelena> {
	...
	private static final ResourceLocation objTesterModelRL = new ResourceLocation(/*"/assets/" + */MainRegistry.MODID, "models/bombletSelena.obj");
	...
	protected RenderBombletSelena(RenderManager renderManager) {
		...
		boyTexture = new ResourceLocation(MainRegistry.MODID, "textures/models/TheGadget3_.png");
	}
