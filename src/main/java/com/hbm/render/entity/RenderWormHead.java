...
public class RenderWormHead extends Render<EntityBOTPrimeHead> {
	...
	public static final IModelCustom body = new HFRWavefrontObject(new ResourceLocation(MainRegistry.MODID, "models/mobs/bot_prime_head.obj"));
	public static final ResourceLocation texture = new ResourceLocation(MainRegistry.MODID, "textures/entity/mark_zero_head.png");
