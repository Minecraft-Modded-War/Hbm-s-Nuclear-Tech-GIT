...
public class RenderRADBeast extends RenderLiving<EntityRADBeast> {
	...
	private static final ResourceLocation blazeTextures = new ResourceLocation(MainRegistry.MODID, "textures/entity/radbeast.png");
    private static final ResourceLocation mask = new ResourceLocation(MainRegistry.MODID, "textures/models/ModelM65Blaze.png");
