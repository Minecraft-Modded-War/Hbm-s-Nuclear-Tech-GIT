...
public class RenderSRocket extends Render<EntityRocketHoming> {
	...
	private static final ResourceLocation texture = new ResourceLocation(MainRegistry.MODID + ":textures/models/ModelSRocket.png");
	...
	public void doRender(EntityRocketHoming rocket, double x, double y, double z, float entityYaw, float partialTicks) {
		...
		if(rocket.getIsCritical())
			bindTexture(new ResourceLocation(MainRegistry.MODID + ":textures/models/ModelSVTRocket.png"));
		else
			bindTexture(new ResourceLocation(MainRegistry.MODID + ":textures/models/ModelSRocket.png"));
