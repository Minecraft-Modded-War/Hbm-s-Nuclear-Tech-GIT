...
public class RenderWormBody extends Render<EntityBOTPrimeBody> {
	...
	public static final IModelCustom body = new HFRWavefrontObject(new ResourceLocation(MainRegistry.MODID, "models/mobs/bot_prime_body.obj"));
	public static final ResourceLocation texture = new ResourceLocation(MainRegistry.MODID, "textures/entity/mark_zero_body.png");
