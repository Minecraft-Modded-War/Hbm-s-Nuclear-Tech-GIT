...
public class RenderShrapnel extends Render<Entity> {
	...
	public void doRender(Entity rocket, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_,
		...
		bindTexture(new ResourceLocation(MainRegistry.MODID + ":textures/entity/shrapnel.png"));
	...
	protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
		return new ResourceLocation(MainRegistry.MODID + ":textures/models/shrapnel.png");
	}
}
