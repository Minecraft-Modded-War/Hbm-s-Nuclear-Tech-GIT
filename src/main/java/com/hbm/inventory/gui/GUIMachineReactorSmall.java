...
public class GUIMachineReactorSmall extends GuiInfoContainer {
	...
	private static ResourceLocation texture = new ResourceLocation(MainRegistry.MODID + ":textures/gui/gui_reactor_experimental.png");
	private static ResourceLocation overlay = new ResourceLocation(MainRegistry.MODID + ":textures/gui/gui_reactor_overlay_experimental.png");
